...
io.popen("cd File_Bot && wget https://raw.github.com/frawnwa12/offlinefr/main/File_Bot/commands.lua") 
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'اوفلاين'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
os.execute('wget https://raw.github.com/frawnwa12/offlinefr/main/DRAGON.lua')
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "اوفلاين")
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.github.com/frawnwa12/offlinefr/main/DRAGON.lua')
os.execute('wget https://raw.github.com/frawnwa12/offlinefr/main/library')
os.execute('wget https://raw.github.com/frawnwa12/offlinefr/main/File_Bot')
send(msg.chat_id_, msg.id_,'⋆ تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝗗𝙀𝗩 𝙊𝗙𝗙𝗟𝙄𝗡𝙀 ',url="t.me/D_E_V_O_F_F_L_I_N_E"},{text = '𝗗𝙀𝗩 𝗞𝙄𝗡𝗚𝙊𝙊',url="t.me/D_E_V_K_I_N_G_O_O"}},
{{text = ' 𝗗𝙀𝗩 𝗭𝗞𝗟𝗔𝗟' ,url="t.me/M_ahmu_d"},{text = ' 𝗗𝙀𝗩 𝗛𝗔𝙍𝗕𝙊𝗞𝗔𝗔𝙄',url="t.me/G_G_A_B_E_3"}},
{{text = '𝗗𝙀𝗩 𝗙𝙍𝗔𝙒𝗡',url="t.me/DEV_FRAWN"},{text = '𝗦𝙊𝙐𝙍𝗖𝙀 𝙊𝗙𝗙𝗟𝙄𝗡𝙀 ', url="t.me/source_frawn"}}, 
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/source_frawn/354&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'اوفلاين' or text == 'مبرمج السورس' or text == 'ياميدو' then
local Text = [[
⋆ يمكنك التواصل معي..↑↓
...
if text == 'داد' or text == 'فرعون' or text == 'المبرمج الكبير' then
local Text = [[
⋆ يمكنك التواصل معي..↑↓
⋆ عن طريق معرفي بلاسفل..↑↓
]]
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
https://youtube.com/channel/UCtAKD-QpkrkFHXnD07Pkebg
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '00:00',url="t.me/source_frawn"}},
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/source_frawn/354&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس اوفلاين ؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس اوفلاين ؟ ", 
"كم مره حبيت؟ ", 
...
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
⋆ 𝙲𝙷 - [𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻](t.me/source_frawn) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
...
if text == 'العاب اوفلاين' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.github.com/frawnwa12/offlinefr/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n⋆ اهلا بك في متجر ملفات اوفلاين\n⋆ ملفات السورس ↓\n≪╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸≫\n\n"
...
local json_file, res = https.request("https://raw.github.com/frawnwa12/offlinefr/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_,"⋆ عذرا الملف لايلب سوبر سورس اوفلاين \n") 
end
return false
end
...
if text == ("مسح قائمه اوفلاين") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n⋆ تم مسح قائمه اوفلاين')
return false
end

if text == 'قائمه اوفلاين' and Sudo(msg) then
...
if #list == 0 then
t = "⋆ لا يوجد احد في قائمه اوفلاين"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع اوفلاين") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local source_frawn = database:get(bot_id..'text:ch:user')
if source_frawn then
send(msg.chat_id_, msg.id_,'['..source_frawn..']')
...
if text and text:match("^رفع اوفلاين @(.*)$") and Sudo(msg) then
local username = text:match("^رفع اوفلاين @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local source_frawn = database:get(bot_id..'text:ch:user')
if source_frawn then
send(msg.chat_id_, msg.id_,'['..source_frawn..']')
...
if text and text:match("^رفع اوفلاين (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع اوفلاين (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local source_frawn = database:get(bot_id..'text:ch:user')
if source_frawn then
send(msg.chat_id_, msg.id_,'['..source_frawn..']')
...
if text == ("تنزيل اوفلاين") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local source_frawn = database:get(bot_id..'text:ch:user')
if source_frawn then
send(msg.chat_id_, msg.id_,'['..source_frawn..']')
...
if text and text:match("^تنزيل اوفلاين @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل اوفلاين @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local source_frawn = database:get(bot_id..'text:ch:user')
if source_frawn then
send(msg.chat_id_, msg.id_,'['..source_frawn..']')
...
if text and text:match("^تنزيل اوفلاين (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل اوفلاين (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local source_frawn = database:get(bot_id..'text:ch:user')
if source_frawn then
send(msg.chat_id_, msg.id_,'['..source_frawn..']')
...
' }\n'..'⋆  الايدي بالصوره ⤌ { '..idph..
' }\n'..'⋆  الرفع ⤌ { '..setadd..
' }\n'..'⋆  الحظر ⤌ { '..banm..' }\n\n╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸\n⋆ قناة سورس اوفلاين ↓\n [ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻](t.me/source_frawn) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
end --الكود حصري سورس اوفلاين يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'اوفلاين').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه اوفلاين') 
return false
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'اوفلاين').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'اوفلاين')
local DRAGON_Msg = {
'⋆ يوه '..Namebot..' زهق منك😒',
'⋆ نعم ياعيون '..Namebot..' 😻💓',
'⋆ عايز اي من '..Namebot..' 🙄💛',
...
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
⋆ اليك الاوامر الخاص بسورس اوفلاين .
